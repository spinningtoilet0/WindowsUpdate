...
namespace WindowsUpdate
{
    public class Shared
    {
        ...
        public static Form pubForm { get; set; }
        ...
        private static void KeepFullScreen(object sender, EventArgs e)
        {
            pubForm.FormBorderStyle = FormBorderStyle.None;
            pubForm.WindowState = FormWindowState.Maximized;
        }

        public static void Nothing(object sender, EventArgs e)
        {
    ...
    // stuff from https://www.codeproject.com/Articles/19004/A-Simple-C-Global-Low-Level-Keyboard-Hook
